  ...
  return (
    ...
    <div className="relative flex h-screen overflow-hidden">
      {/* Botão flutuante pra reabrir — só existe quando a fila está recolhida.
          Fica por cima do conteúdo, sem reservar espaço nenhum, igual ao
          padrão da sidebar aqui do Claude que você apontou como referência. */}
      {collapsed && (
        <button
      ...
      {!collapsed && (
        ...
        >
          <div className="flex flex-col h-full">
            {/* Header em linha única — sem botão de recolher aqui (fica só no
                painel de detalhe, já que ele afeta os dois ao mesmo tempo).
                Busca e filtro viram ícones que abrem popover/menu ao clicar,
                em vez de ocupar uma segunda linha inteira. */}
            <div className="p-3.5 border-b border-border bg-card shrink-0 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  {/* Nova demanda — só ícone, fica no canto (posição universal
                      de ação principal: Gmail, Slack, etc. usam o mesmo lugar) */}
                  <button
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin p-2 space-y-1.5">
              ...
              {/* Card no formato combinado: foto+pip, nome, hora, prévia da mensagem.
                  Sem protocolo/prazo/responsável/canal aqui — isso tudo mora só no
                  painel de detalhe agora. "Não lidas" fica de fora até existir um
                  jeito real de contar (ver pendência anotada). */}
              {data.map((d: any) => {
